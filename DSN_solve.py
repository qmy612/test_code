...
caffenet = caffe.Net('5stage-vgg-deploy.prototxt', base_weights, caffe.TEST)

#caffenet.blobs['data'].reshape(caffenet.blobs['data'].shape[0], 1, caffenet.blobs['data'].shape[2], caffenet.blobs['data'].shape[3])
#print caffenet.blobs['data'].shape[1]
...
#solver.restore('binary_iter_300000.solverstate')
